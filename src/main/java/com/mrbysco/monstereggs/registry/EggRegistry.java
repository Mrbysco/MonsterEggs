...
public class EggRegistry {
	...
	public static final RegistryObject<Block> CAVE_SPIDER_EGG = BLOCKS.register("cave_spider_egg", () -> new MonsterEggBlock(() -> EntityType.CAVE_SPIDER, Block.Properties.of(Material.EGG, MaterialColor.COLOR_GREEN).strength(0.5F).sound(SoundType.GRASS).lightLevel((state) -> 4).noOcclusion()));
	public static final RegistryObject<Block> CREEPER_EGG = BLOCKS.register("creeper_egg", () -> new MonsterEggBlock(() -> EntityType.CREEPER, Block.Properties.of(Material.EGG, MaterialColor.COLOR_GREEN).strength(0.5F).sound(SoundType.GRASS).lightLevel((state) -> 4).noOcclusion()));
	public static final RegistryObject<Block> ENDERMAN_EGG = BLOCKS.register("enderman_egg", () -> new MonsterEggBlock(() -> EntityType.ENDERMAN, Block.Properties.of(Material.EGG, MaterialColor.COLOR_GREEN).strength(0.5F).sound(SoundType.GRASS).lightLevel((state) -> 4).noOcclusion()));
	public static final RegistryObject<Block> SKELETON_EGG = BLOCKS.register("skeleton_egg", () -> new MonsterEggBlock(() -> EntityType.SKELETON, Block.Properties.of(Material.EGG, MaterialColor.COLOR_GREEN).strength(0.5F).sound(SoundType.GRASS).lightLevel((state) -> 4).noOcclusion()));
	public static final RegistryObject<Block> SPIDER_EGG = BLOCKS.register("spider_egg", () -> new MonsterEggBlock(() -> EntityType.SPIDER, Block.Properties.of(Material.EGG, MaterialColor.COLOR_GREEN).strength(0.5F).sound(SoundType.GRASS).lightLevel((state) -> 4).noOcclusion()));
	public static final RegistryObject<Block> ZOMBIE_EGG = BLOCKS.register("zombie_egg", () -> new MonsterEggBlock(() -> EntityType.ZOMBIE, Block.Properties.of(Material.EGG, MaterialColor.COLOR_GREEN).strength(0.5F).sound(SoundType.GRASS).lightLevel((state) -> 4).noOcclusion()));
