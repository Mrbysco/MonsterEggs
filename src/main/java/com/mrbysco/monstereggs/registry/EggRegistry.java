...
public class EggRegistry {
	...
	public static final RegistryObject<Item> CAVE_SPIDER_EGG_ITEM = ITEMS.register("cave_spider_egg", () -> new BlockItem(CAVE_SPIDER_EGG.get(), new Item.Properties().tab(MonsterEggs.TAB_EGGS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> CREEPER_EGG_ITEM = ITEMS.register("creeper_egg", () -> new BlockItem(CREEPER_EGG.get(), new Item.Properties().tab(MonsterEggs.TAB_EGGS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ENDERMAN_EGG_ITEM = ITEMS.register("enderman_egg", () -> new BlockItem(ENDERMAN_EGG.get(), new Item.Properties().tab(MonsterEggs.TAB_EGGS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> SKELETON_EGG_ITEM = ITEMS.register("skeleton_egg", () -> new BlockItem(SKELETON_EGG.get(), new Item.Properties().tab(MonsterEggs.TAB_EGGS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> SPIDER_EGG_ITEM = ITEMS.register("spider_egg", () -> new BlockItem(SPIDER_EGG.get(), new Item.Properties().tab(MonsterEggs.TAB_EGGS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ZOMBIE_EGG_ITEM = ITEMS.register("zombie_egg", () -> new BlockItem(ZOMBIE_EGG.get(), new Item.Properties().tab(MonsterEggs.TAB_EGGS).rarity(Rarity.UNCOMMON)));
}