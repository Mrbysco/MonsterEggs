...
public class EggPlacements {
	...
	public static final Holder<PlacedFeature> CAVE_SPIDER_HANGING_EGG = makeEggFeature("cave_spider_hanging_egg",
	...
	public static final Holder<PlacedFeature> CAVE_SPIDER_EGG = makeEggFeature("cave_spider_egg",
			EggRegistry.CAVE_SPIDER_EGG.get(),
	...
	public static final Holder<PlacedFeature> CREEPER_HANGING_EGG = makeEggFeature("creeper_hanging_egg",
	...
	public static final Holder<PlacedFeature> CREEPER_EGG = makeEggFeature("creeper_egg",
			EggRegistry.CREEPER_EGG.get(),
	...
	public static final Holder<PlacedFeature> ENDERMAN_HANGING_EGG = makeEggFeature("enderman_hanging_egg",
	...
	public static final Holder<PlacedFeature> ENDERMAN_EGG = makeEggFeature("enderman_egg",
			EggRegistry.ENDERMAN_EGG.get(),
	...
	public static final Holder<PlacedFeature> SKELETON_HANGING_EGG = makeEggFeature("skeleton_hanging_egg",
	...
	public static final Holder<PlacedFeature> SKELETON_EGG = makeEggFeature("skeleton_egg",
			EggRegistry.SKELETON_EGG.get(),
	...
	public static final Holder<PlacedFeature> SPIDER_HANGING_EGG = makeEggFeature("spider_hanging_egg",
	...
	public static final Holder<PlacedFeature> SPIDER_EGG = makeEggFeature("spider_egg",
			EggRegistry.SPIDER_EGG.get(),
	...
	public static final Holder<PlacedFeature> ZOMBIE_HANGING_EGG = makeEggFeature("zombie_hanging_egg",
	...
	public static final Holder<PlacedFeature> ZOMBIE_EGG = makeEggFeature("zombie_egg",
			EggRegistry.ZOMBIE_EGG.get(),
	...
	public static final Holder<PlacedFeature> makeEggFeature(String name, Block block, Supplier<Integer> tries, Supplier<Integer> rarity, Supplier<Integer> count, Direction direction) {
		...
		Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> featureHolder = generateFeature(name, state, tries);
		return PlacementUtils.register(new ResourceLocation(MonsterEggs.MOD_ID, name).toString(), featureHolder, List.of(RarityFilter.onAverageOnceEvery(rarity.get()), CountPlacement.of(UniformInt.of(0, count.get())), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE,
	...
	public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> generateFeature(String name, BlockState state, Supplier<Integer> tries) {
		BlockStateProvider provider = BlockStateProvider.simple(state);
		return FeatureUtils.register(new ResourceLocation(MonsterEggs.MOD_ID, name).toString(), Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
